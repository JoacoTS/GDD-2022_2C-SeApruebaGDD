...
create table SE_APRUEBA_GDD.BI_PROD_X_VENTA (
	...
	FOREIGN KEY (PRODUCTO_ID) REFERENCES SE_APRUEBA_GDD.BI_PRODUCTO(PRODUCTO_ID),
	FOREIGN KEY (VENTA_ID) REFERENCES SE_APRUEBA_GDD.VENTA(VENTA_ID)
);

go

create table SE_APRUEBA_GDD.BI_PROD_X_COMPRA (
