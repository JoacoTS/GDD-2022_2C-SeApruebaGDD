...
-----DROPS TRIGGERS
/*
DROP INDEX COMPRA_INDEX ON SE_APRUEBA_GDD.COMPRA
DROP INDEX DESCUENTO_COMPRA_INDEX ON SE_APRUEBA_GDD.DESCUENTO_COMPRA
DROP INDEX MEDIO_PAGO_COMPRA_INDEX ON SE_APRUEBA_GDD.MEDIO_PAGO_COMPRA
DROP INDEX PROVEEDOR_INDEX ON SE_APRUEBA_GDD.PROVEEDOR
DROP INDEX VARIANTE_X_PRODUCTO_INDEX ON SE_APRUEBA_GDD.VARIANTE_X_PRODUCTO
DROP INDEX VARIANTE_INDEX ON SE_APRUEBA_GDD.VARIANTE
DROP INDEX TIPO_VARIANTE_INDEX ON SE_APRUEBA_GDD.TIPO_VARIANTE
DROP INDEX PRODUCTO_INDEX ON SE_APRUEBA_GDD.PRODUCTO
DROP INDEX MATERIAL_INDEX ON SE_APRUEBA_GDD.MATERIAL
DROP INDEX CATEGORIA_INDEX ON SE_APRUEBA_GDD.CATEGORIA
DROP INDEX MARCA_INDEX ON SE_APRUEBA_GDD.MARCA
DROP INDEX CUPON_INDEX ON SE_APRUEBA_GDD.CUPON
DROP INDEX DESCUENTO_VENTA_X_VENTA_INDEX ON SE_APRUEBA_GDD.DESCUENTO_VENTA_X_VENTA
DROP INDEX VENTA_INDEX ON SE_APRUEBA_GDD.VENTA
DROP INDEX ENVIO_VENTA_INDEX ON SE_APRUEBA_GDD.ENVIO_VENTA
DROP INDEX MEDIO_PAGO_VENTA_INDEX ON SE_APRUEBA_GDD.MEDIO_PAGO_VENTA
DROP INDEX CANAL_VENTA_INDEX ON SE_APRUEBA_GDD.CANAL_VENTA
DROP INDEX CLIENTE_INDEX ON SE_APRUEBA_GDD.CLIENTE
DROP INDEX UBICACION_INDEX ON SE_APRUEBA_GDD.UBICACION
DROP INDEX CODIGO_POSTAL_INDEX ON SE_APRUEBA_GDD.CODIGO_POSTAL
DROP INDEX PROVINCIA_INDEX ON SE_APRUEBA_GDD.PROVINCIA*/
