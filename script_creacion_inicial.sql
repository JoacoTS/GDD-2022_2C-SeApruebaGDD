...
IF OBJECT_ID('SE_APRUEBA_GDD.PROVINCIA.PROVINCIA_INDEX') IS NOT NULL
  DROP INDEX SE_APRUEBA_GDD.PROVINCIA.PROVINCIA_INDEX
  GO

IF OBJECT_ID('SE_APRUEBA_GDD.CODIGO_POSTAL.CODIGO_POSTAL_INDEX') IS NOT NULL
  DROP INDEX SE_APRUEBA_GDD.CODIGO_POSTAL.CODIGO_POSTAL_INDEX
  GO

IF OBJECT_ID('SSE_APRUEBA_GDD.UBICACION.UBICACION_INDEX') IS NOT NULL
  DROP INDEX SE_APRUEBA_GDD.UBICACION.UBICACION_INDEX
  GO

IF OBJECT_ID('SE_APRUEBA_GDD.CLIENTE.CLIENTE_INDEX') IS NOT NULL
  DROP INDEX SE_APRUEBA_GDD.CLIENTE.CLIENTE_INDEX
  GO

IF OBJECT_ID('SE_APRUEBA_GDD.CANAL_VENTA.CANAL_VENTA_INDEX') IS NOT NULL
  DROP INDEX SE_APRUEBA_GDD.CANAL_VENTA.CANAL_VENTA_INDEX
  GO

IF OBJECT_ID('SE_APRUEBA_GDD.MEDIO_PAGO_VENTA.MEDIO_PAGO_VENTA_INDEX') IS NOT NULL
  DROP INDEX SE_APRUEBA_GDD.MEDIO_PAGO_VENTA.MEDIO_PAGO_VENTA_INDEX
  GO

IF OBJECT_ID('SE_APRUEBA_GDD.ENVIO_VENTA.ENVIO_VENTA_INDEX') IS NOT NULL
  DROP INDEX SE_APRUEBA_GDD.ENVIO_VENTA.ENVIO_VENTA_INDEX
  GO

IF OBJECT_ID('SE_APRUEBA_GDD.VENTA.VENTA_INDEX') IS NOT NULL
  DROP INDEX SE_APRUEBA_GDD.VENTA.VENTA_INDEX
  GO

IF OBJECT_ID('SE_APRUEBA_GDD.DESCUENTO_VENTA_X_VENTA.DESCUENTO_VENTA_X_VENTA_INDEX') IS NOT NULL
  DROP INDEX SE_APRUEBA_GDD.DESCUENTO_VENTA_X_VENTA.DESCUENTO_VENTA_X_VENTA_INDEX
  GO

IF OBJECT_ID('SE_APRUEBA_GDD.CUPON.CUPON_INDEX') IS NOT NULL
  DROP INDEX SE_APRUEBA_GDD.CUPON.CUPON_INDEX
  GO

IF OBJECT_ID('SE_APRUEBA_GDD.MARCA.MARCA_INDEX') IS NOT NULL
  DROP INDEX SE_APRUEBA_GDD.MARCA.MARCA_INDEX
  GO

IF OBJECT_ID('SE_APRUEBA_GDD.CATEGORIA.CATEGORIA_INDEX') IS NOT NULL
  DROP INDEX SE_APRUEBA_GDD.CATEGORIA.CATEGORIA_INDEX
  GO

IF OBJECT_ID('SE_APRUEBA_GDD.MATERIAL.MATERIAL_INDEX') IS NOT NULL
  DROP INDEX SE_APRUEBA_GDD.MATERIAL.MATERIAL_INDEX
  GO

IF OBJECT_ID('SE_APRUEBA_GDD.PRODUCTO.PRODUCTO_INDEX') IS NOT NULL
  DROP INDEX SE_APRUEBA_GDD.PRODUCTO.PRODUCTO_INDEX
  GO

IF OBJECT_ID('SE_APRUEBA_GDD.TIPO_VARIANTE.TIPO_VARIANTE_INDEX') IS NOT NULL
  DROP INDEX SE_APRUEBA_GDD.TIPO_VARIANTE.TIPO_VARIANTE_INDEX
  GO

IF OBJECT_ID('SE_APRUEBA_GDD.VARIANTE.VARIANTE_INDEX') IS NOT NULL
  DROP INDEX SE_APRUEBA_GDD.VARIANTE.VARIANTE_INDEX
  GO

IF OBJECT_ID('SE_APRUEBA_GDD.VARIANTE_X_PRODUCTO.VARIANTE_X_PRODUCTO_INDEX') IS NOT NULL
  DROP INDEX SE_APRUEBA_GDD.VARIANTE_X_PRODUCTO.VARIANTE_X_PRODUCTO_INDEX
  GO

IF OBJECT_ID('SE_APRUEBA_GDD.PROVEEDOR.PROVEEDOR_INDEX') IS NOT NULL
  DROP INDEX SE_APRUEBA_GDD.PROVEEDOR.PROVEEDOR_INDEX
  GO

IF OBJECT_ID('SE_APRUEBA_GDD.MEDIO_PAGO_COMPRA.MEDIO_PAGO_COMPRA_INDEX') IS NOT NULL
  DROP INDEX SE_APRUEBA_GDD.MEDIO_PAGO_COMPRA.MEDIO_PAGO_COMPRA_INDEX
  GO

IF OBJECT_ID('SE_APRUEBA_GDD.DESCUENTO_COMPRA.DESCUENTO_COMPRA_INDEX') IS NOT NULL
  DROP INDEX SE_APRUEBA_GDD.DESCUENTO_COMPRA.DESCUENTO_COMPRA_INDEX
  GO

IF OBJECT_ID('SE_APRUEBA_GDD.COMPRA.COMPRA_INDEX') IS NOT NULL
  DROP INDEX SE_APRUEBA_GDD.COMPRA.COMPRA_INDEX
  GO
...
BEGIN TRY
	...
	EXECUTE SE_APRUEBA_GDD.migrar_proveedores
...
IF (EXISTS (SELECT 1 FROM SE_APRUEBA_GDD.PROVINCIA)
	...
	AND EXISTS (SELECT 1 FROM SE_APRUEBA_GDD.ENVIO_VENTA)
	AND EXISTS (SELECT 1 FROM SE_APRUEBA_GDD.VENTA)
	AND EXISTS (SELECT 1 FROM SE_APRUEBA_GDD.DESCUENTO_VENTA_X_VENTA)
	AND EXISTS (SELECT 1 FROM SE_APRUEBA_GDD.CUPON)
	AND EXISTS (SELECT 1 FROM SE_APRUEBA_GDD.CUPON_X_VENTA)
	AND EXISTS (SELECT 1 FROM SE_APRUEBA_GDD.MARCA)
	AND EXISTS (SELECT 1 FROM SE_APRUEBA_GDD.CATEGORIA)
	AND EXISTS (SELECT 1 FROM SE_APRUEBA_GDD.MATERIAL)
	AND EXISTS (SELECT 1 FROM SE_APRUEBA_GDD.PRODUCTO)
	AND EXISTS (SELECT 1 FROM SE_APRUEBA_GDD.TIPO_VARIANTE)
	AND EXISTS (SELECT 1 FROM SE_APRUEBA_GDD.VARIANTE)
	AND EXISTS (SELECT 1 FROM SE_APRUEBA_GDD.VARIANTE_X_PRODUCTO)
	AND EXISTS (SELECT 1 FROM SE_APRUEBA_GDD.MEDIO_PAGO_COMPRA)
	AND EXISTS (SELECT 1 FROM SE_APRUEBA_GDD.COMPRA)
	AND EXISTS (SELECT 1 FROM SE_APRUEBA_GDD.PROD_X_VENTA)
	AND EXISTS (SELECT 1 FROM SE_APRUEBA_GDD.PROD_X_COMPRA)
	AND EXISTS (SELECT 1 FROM SE_APRUEBA_GDD.PROVEEDOR)
	AND EXISTS (SELECT 1 FROM SE_APRUEBA_GDD.DESCUENTO_COMPRA)
	AND EXISTS (SELECT 1 FROM SE_APRUEBA_GDD.DESCUENTO_COMPRA_X_COMPRA)
